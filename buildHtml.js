...
function renderIndicacionesGenerales(items) {
  const defaultItems = [
    ...
    'Comprar el suplemento de Bisglicinato de magnesio es importante, aunque no imprescindible. Ayudará a conseguir resultados más rápido y lo encontraréis muy fácil en internet o farmacias.',
...
function renderCover(data) {
  ...
  const comidasDia = data.comidasDia || data.comidas || '-'
    ...
    <section class="cover">
      <div class="cover-shell">
        ...
        <div class="cover-focus-card">
          ...
          <div class="cover-meals-pill">
            ${escapeHtml(`${comidasDia} comidas al día`)}
          </div>
        </div>
      </div>
    </section>
  ...
  const comida4Options = [
    {
      ...
      lines: [
        ...
        '3 g Aceite de coco o 3 g Aceite de oliva virgen extra',
      ],
    },
    {
      key: 'c4_o2',
